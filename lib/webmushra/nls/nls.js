...
nls['pl']['previousButton'] = "Poprzedni";
nls['pl']['playButton'] = "Start";
...
nls['pl']['excellent'] = "Doskonały";
nls['pl']['good'] = "Dobry";
nls['pl']['fair'] = "Średni";
nls['pl']['poor'] = "Słaby";
nls['pl']['bad'] = "Zły";
nls['pl']['reference'] = "Wzorzec";
nls['pl']['cond'] = "";
nls['pl']['35'] = "Kotwica";
nls['pl']['75'] = "Kotwica75";
...
nls['pl']['imperceptible'] = "Niezauważalny";
nls['pl']['perceptible'] = "Zauważalny, ale nie irytujący";
...
nls['pl']['quest'] = "Który element jest referencyjny?";
